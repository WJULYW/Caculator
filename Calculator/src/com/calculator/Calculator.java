...
public class Calculator {
    ...
    private static final int BUTTON_WIDTH = 80; // 按键宽度Button width
    private static final int BUTTON_HEIGHT = 70; // 高度Button height
    ...
    */
    ...
    private double calc(double x, String input, char opt) {  //计算方法
    ...
    private void onSwitchTheme() {  //显示颜色
    ...
    private void onShowScientificMode() { //显示科学计算模式
        if (isScientificMode) {
